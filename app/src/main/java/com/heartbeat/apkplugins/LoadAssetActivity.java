...
public class LoadAssetActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Resources resources =PluginsManager
                .getInstance(this).getPluginHolder("com.zhouyuan.plugin").resources;
        /**
         *获取图片资源
         */
...
//                "com.zhouyuan.plugin"));
        ...
        final String appName = resources.getString(resources.getIdentifier("app_name", "string", "com.zhouyuan.plugin"));
